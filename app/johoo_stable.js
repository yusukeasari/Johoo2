...
(function() {
  ...
  QuickSearchPanel = (function(superClass) {
    ...
    QuickSearchPanel.prototype.initialize = function() {
      $(this.textform).on('keydown', this.textChanged);
      $(this.textform).on('keyup', this.textChanged);
      $(this.cancelbutton).on('click', this.textCancel);
      return $(this.cancelbutton).hide();
    };

    QuickSearchPanel.prototype.textChanged = function(evt) {
    ...
    QuickSearchPanel.prototype.textCancel = function(evt) {
      $(this.textform).val('');
      return $(this.cancelbutton).hide();
    };
  ...
  Pyramid = (function(superClass) {
    ...
    Pyramid.prototype.onTouchStart = function(e) {
      if (e.touches.length > 1) {
        return this.onGestureStart(e);
      } else {
        return this.onMouseDown(e);
      }
    };

    Pyramid.prototype.onTouchMove = function(e) {
      if (e.touches.length > 1) {
        return this.onGestureMove(e);
      } else {
        return this.onMouseMove(e);
      }
    };

    Pyramid.prototype.onTouchEnd = function(e) {
      if (e.touches.length > 1) {
        return this.onGestureEnd(e);
      } else {
